...
$sql = "SELECT name, trans_mode, time, email, phone, gender FROM user_info WHERE date='$date' AND source='$source' AND destination='$dest' AND TIME_TO_SEC('$time') - TIME_TO_SEC(time) < 1800 ";
